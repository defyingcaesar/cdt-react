  ...
  return (
    <div>
      ...
      <div className="row mt-5">
        ...
        <h2>Trendline</h2>
          <iframe src="http://3.230.79.223:3000/grafana/d-solo/uAmm-cE7k/da-gama-dam-level?orgId=1&from=1648764000000&to=1649089019952&panelId=5" width="100%" height="400" title="dam-table" frameBorder="0"></iframe>
        </div>
      </div>
    </div>
  );
