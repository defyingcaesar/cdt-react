...
const PipeThree = () => {
  ...
  return (
    ...
    <h2>Pipe Three</h2>
      ...
      <div className="row">
        <div className="col-md-12 col-sm-12 mb-3">
          <iframe src="https://grafana.comdatech.xyz/d-solo/QrfhicPnk/da-gama-pipes?orgId=1&refresh=15m&from=now&to=now-7d&panelId=10" width="100%" height="100%" frameborder="0" title="Pipe 1 Acc"></iframe>
        </div>
      </div>
    </div>
  );
